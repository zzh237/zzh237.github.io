...
and deep learning LSTM</b>) to do different predication, such as minimum antibiotic susceptible concentration for different sample. I also participated in built a multi-functional software 
